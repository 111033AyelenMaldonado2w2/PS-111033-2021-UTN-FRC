...
$(document).ready(function () {
    ...
    $('#btnRecalcular').click(function () {
        var montoAntes = $('#importeOrigen').val();
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (result.length > 0) {
                        ...
                        if (agrega == "") {
                            deu = $('#deuda').val();
                            $('#totNuevo').val('$ ' + formateoPuntosyComas(montoAntes));
                            $('#aRefinan').val('$ ' + formateoPuntosyComas(montoAntes));
    ...
    for (var b in a) { //Como nos devuelve un array iteramos
        ...
        if (typeof c == "object") { //Solo buscamos los objetos
            c.onclick = function () { //Asignamos un evento onclick
                ...
                solicidatoOrigen = tr.children[5];
                    ...
                    success: function (result) {
                        ...
                        if (result.length > 0) {
                            for (var i = 0; i < result.length; i++) {
                                ...
                                $('#importeOrigen').val(solicidatoOrigen.textContent);
